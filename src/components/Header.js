...
import Logo2 from '../assets/Logo2.jpg'; // ✅ Correct import
      ...
      <div className="container-max">
        <div className="flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center">
            <img
              src={Logo2} // use imported image here
          ...
          >
            <span
              className={`block w-6 h-0.5 bg-nature-green transition-all duration-300 ${
